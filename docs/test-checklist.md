...
| --- | --- | --- | --- | --- |
| ☐ | 0.1 | CI beş işte de yeşil | GitHub Actions son koşum | ubuntu 53/53 · macOS 53/53 · windows 34/34 · PS 5.1 34/34 · lint |
| ☐ | 0.2 | Temiz clone'da smoke | `git clone` → `python3 tests/smoke_test.py` | 53 geçti, 0 başarısız |
...
| 2026-09-01 | CI: ubuntu · macOS · windows · PowerShell 5.1 | 53/53 · 53/53 · 34/34 · 34/34 |
